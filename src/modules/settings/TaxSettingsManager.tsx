        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <CardDescription>Gestiona los impuestos aplicables a tus facturas</CardDescription>
            </div>
          </div>
                      ...
                      <FormItem>
                        ...
                        <Select onValueChange={field.onChange} value={field.value}>
                          ...
                          <SelectContent>
                            ...
                            <SelectItem value="foreign_currency">Divisas</SelectItem>
                          </SelectContent>
                        </Select>
                        <FormMessage />
                      </FormItem>
            ...
            <TableBody>
              {taxes.map((tax) => (
                <TableRow key={tax.id}>
                  ...
                  <TableCell className="capitalize">{tax.applies_to}</TableCell>
                  <TableCell>
                    {tax.is_active ? (
