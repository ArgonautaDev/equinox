...
OutputBaseFilename=Equinox_ERP_{#MyAppVersion}_x64_Setup
SetupIconFile=src-tauri\icons\icon.ico
Compression=lzma
SolidCompression=yes
WizardStyle=modern
; Specify this installer is for x64 architecture only
...
[Files]
; Main executable from target/x86_64-pc-windows-msvc/release (x64 build)
Source: "src-tauri\target\x86_64-pc-windows-msvc\release\equinox-erp.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "src-tauri\target\x86_64-pc-windows-msvc\release\equinox_lib.dll"; DestDir: "{app}"; Flags: ignoreversion
